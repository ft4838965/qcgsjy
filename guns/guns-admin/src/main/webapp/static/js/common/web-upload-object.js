...
(function() {
	...
	var $WebUpload = function(pictureId,url) {
		...
		this.uploadUrl = Feng.ctxPath +(url!=undefined&&url!=""?url:'/mgr/upload');
	...
	$WebUpload.prototype = {
		 ...
		 * 绑定事件
		 */
		bindEvent : function(bindedObj,url) {
			var me =  this;
			...
			bindedObj.on('uploadSuccess', function(file,response) {
				...
				$("#" + me.pictureId).val(url!=undefined&&url!=""?response.data:response);
			});
