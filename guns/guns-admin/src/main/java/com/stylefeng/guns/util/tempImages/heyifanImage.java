package com.stylefeng.guns.util.tempImages;
...
public class heyifanImage {
     ...
     */
        public static void main(String[] args) {
            ...
            String source = "F:/images/heyifan.jpg";  //源图片路径
            String icon = "F:/images/icon.png"; //覆盖图片路径
            ...
            String result = null;
            //给图片添加图片水印
            result = heyifanImage.markImageByMoreIcon(icon,source,output,imageName,imageType,degree);
