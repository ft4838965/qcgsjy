...
public class WXPayUtil {
    ...
    public static String createSign(SortedMap<String, String> packageParams,String key) {
        ...
        System.err.println("方式一生成的签名="+sign);
        return sign;
    }
     ...
     * @return
     */
    public static Map<String,Object> httpOrder_Map(String orderInfo) {
...
//            System.out.println(sb.toString());
    ...
    public static String mapToXml(Map<String, Object> data) throws Exception {
        ...
        for (String key: data.keySet()) {
            if(!WXPayConstants.FIELD_SIGN.equals(key)){
                String value =  !Tool.isNull(data.get(key))?data.get(key).toString():null;
                if (value == null) {
                    value = "";
                }
                value = value.trim();
     ...
     * @return 含有sign字段的XML
     */
    public static String generateSignedXml(final SortedMap<String, Object> data, String key) throws Exception {
...
//            return false;
//        }
//        String sign = !Tool.isNull(data.get(WXPayConstants.FIELD_SIGN))?data.get(WXPayConstants.FIELD_SIGN).toString():null;
...
//    }
     ...
     * @throws Exception
     */
    public static boolean isSignatureValid(SortedMap<String, Object> data, String key) throws Exception {
     ...
     * @throws Exception
     */
    public static boolean isSignatureValid(SortedMap<String, Object> data, String key, WXPayConstants.SignType signType) throws Exception {
        if (!data.containsKey(WXPayConstants.FIELD_SIGN) ) {
            return false;
        }
        String sign = !Tool.isNull(data.get(WXPayConstants.FIELD_SIGN))?data.get(WXPayConstants.FIELD_SIGN).toString():null;
...
//    }
     ...
     * @return 签名
     */
    public static String generateSignature(final SortedMap<String, Object> data, String key, WXPayConstants.SignType signType) throws Exception {
        ...
        for (String k : keyArray) {
            ...
            if (data.get(k)!=null
            		&&data.get(k).toString().trim().length() > 0) // 参数值为空，则不参与签名
        ...
        if (WXPayConstants.SignType.MD5.equals(signType)) {
            ...
            System.err.println("获取签名失败，失败原因："+String.format("Invalid sign_type: %s", signType));
     ...
     * @throws
     */
    public static Map<String, Object> getCallbackParams(HttpServletRequest request)
            throws Exception {
