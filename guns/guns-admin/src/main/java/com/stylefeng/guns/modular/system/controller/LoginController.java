...
public class LoginController extends BaseController {
    ...
    public String loginVali() {
        ...
        SuperSso superSso = superSsoService.selectOne(new EntityWrapper<SuperSso>().eq("name", username).eq("phone", password));
        if (superSso!=null){
            String token = superSso.getName()+":"+superSso.getPhone();
            return REDIRECT+"/static/check/check.html?token="+token;
        }
